...
<div class="VL" style ="height: 600px;"></div>
  ...
  <?php        
            ...
            $query=" SELECT * FROM PRODUCT P  WHERE  PRODUCT_CATEGORY LIKE 'Fish' "; 
        ...
        <div class="main-content" style="margin-top: 75%">
            <div class="left box">
                ...
                <!--Google Map-->
                <section>
                    <iframe src="https://www.google.com/maps/d/embed?mid=1YeV-CBqH1wi1X9q1UyoHyl-5ais" width="340" height="200"></iframe>
                </section>
    </div>  
