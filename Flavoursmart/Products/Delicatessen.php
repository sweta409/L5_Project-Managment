...
<body>
  ...
  <div class="container">
        ...
        <form action="All Products.php" method="get">
          ...
          <div class="collection-sort">
            ...
            <select name="sort_by" class="form-control">
              ...
              <option value="Minimum Price" <?php if($sort_by=="Minimun Price" ) echo 'selected' ?> >Minimun Price
              </option>
              <option value="Maximum Price" <?php if($sort_by=="Maximum Price" ) echo 'selected' ?> >Maximum Price
              </option>
            </select>
          </div>
    ...
    <?php        
            ...
            $query=" SELECT * FROM PRODUCT P  WHERE  PRODUCT_CATEGORY LIKE 'Delicatessen' "; 
